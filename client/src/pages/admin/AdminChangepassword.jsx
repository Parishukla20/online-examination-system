...
const AdminChangePassword = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try { 
      const res = await axios.put(`https://online-examination-system-2-q8o7.onrender.com/api/admin/change/${id}`, form)    //link changed 
  ...
  return (
    <div className="d-flex justify-content-center align-items-start" style={{
      minHeight: "80vh", background: "linear-gradient(135deg, #EEF2FF, #DBEAFE)", paddingTop: "80px"   // soft gradient background
    }}
    >
      <div
