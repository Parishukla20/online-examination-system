            ...
            <tbody>
              {data.map((q, index) => (
                <tr key={q._id}>
                  ...
                  <td>
                    <button className="btn-edit me-2 btn btn-primary" onClick={() => handleEdit(q)}>Edit</button>
                    <button className="btn-delete btn btn-danger" onClick={() => handleDelete(q._id)}>Delete</button>
                  </td>
                </tr>
              ))}
              {data.length === 0 && (
