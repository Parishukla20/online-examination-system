                ...
                <tbody>
                  {data.map((item, i) => (
                    <tr key={item._id }>
                      ...
                      <td>{item.phone}</td>
                      <td>
                        <button className="btn-edit me-2 btn btn-primary" onClick={() => handleEdit(item)}>Edit</button>
                        <button className="btn-delete btn btn-danger" onClick={() => handleDelete(item._id)}>Delete</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
